...
export function SdlcRoadmap() {
  ...
  return (
    <section ref={ref} className="py-16 sm:py-32 max-w-6xl mx-auto px-4 sm:px-6">
      <motion.div
      ...
      >
        ...
        <h3 className="text-3xl sm:text-4xl md:text-5xl font-black text-foreground tracking-tighter leading-tight">
          Roadmap del SDLC
        </h3>
      </motion.div>
