...
export function SdlcIntro() {
  ...
  return (
    <section ref={ref} className="py-32 max-w-5xl mx-auto px-4">
      <motion.div
      ...
      >
        ...
        <h3 className="text-4xl md:text-5xl font-black text-foreground tracking-tighter mb-6 leading-tight">
          ¿Qué es el SDLC?
        </h3>
        <p className="text-foreground/50 text-lg font-medium leading-relaxed max-w-2xl mx-auto">
